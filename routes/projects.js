...
// Features (nested under epic) — no separate detail view; shown inside epic
...
router.post('/:projectId/epics/:epicId/features/:id/status',  requireAuth, featuresCtrl.updateStatus);
